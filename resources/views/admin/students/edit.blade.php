            ...
            <form action="{{ route('admin.students.update', $student) }}" method="POST">
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="date_of_birth"
                        ...
                        placeholder="date_of_birth" value="{{ old('date_of_birth', $student->date_of_birth) }}">
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="enrolment_date"
                        ...
                        placeholder="enrolment_date" value="{{ old('enrolment_date', $student->enrolment_date) }}">
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="telephone_number"
                        ...
                        placeholder="telephone_number" value="{{ old('telephone_number', $student->telephone_number) }}">
